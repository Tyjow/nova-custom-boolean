...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-custom-boolean', __webpack_require__(3));
    Vue.component('detail-nova-custom-boolean', __webpack_require__(6));
    Vue.component('form-nova-custom-boolean', __webpack_require__(9));
});
    ...
    methods: {
        optionClass: function optionClass() {
            if (this.field.colorLabels) {
                return {
                    'text-success': Boolean(this.field.value) ? this.field.labels[1] : false,
                    'text-danger': Boolean(this.field.value) ? this.field.labels[0] : true
                };
            }
        }
    }
...
var render = function() {
  ...
  return _c("span", { class: _vm.optionClass() }, [_vm._v(_vm._s(_vm.bool))])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      "p",
      { staticClass: "text-90 flex", attrs: { slot: "value" }, slot: "value" },
      [_c("span", { class: _vm.optionClass() }, [_vm._v(_vm._s(_vm.bool))])]
    )
  ])
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "w-full max-col-2" }, [
          _c(
            "div",
            ...
            [
              ...
              _c("label", {
                ...
                domProps: { textContent: _vm._s(_vm.bool) }
              })
            ],
            1
          )
